## ![FeedCord Banner](https://github.com/Kamdzy/FeedCord/blob/master/FeedCord/docs/images/FeedCord.png)
...
- Started using the highest release date of result posts as a comparison base for matching new posts
